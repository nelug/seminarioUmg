...
angular.module('seminarioUmg', ['ngRoute', 'ngResource', 'ngMessages', 'ngAnimate', 'ngMdIcons', 'ngMaterial', 'ngJSONPath', 'toaster', 'datatables', 'nvd3', 'ngStorage', 'angular-md5', 'AngularPrint', 'focus-if', 'templates']).config( function($mdThemingProvider) {
